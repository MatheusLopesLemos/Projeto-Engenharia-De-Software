	...
	public JanelaPrincipal(CtrlPrograma c) {
		...
		btnAluno.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				CtrlPrograma c = (CtrlPrograma)getCtrl();
				c.iniciarConsultarAlunos();
			}
		});
		btnAluno.setBounds(40, 25, 120, 50);
		...
		btnTurma.setBounds(170, 25, 120, 50);
		contentPane.add(btnTurma);
		
		JButton btnDisciplina = new JButton("Disciplina");
		btnDisciplina.setBounds(300, 25, 120, 50);
		...
		btnProfessor.setBounds(40, 150, 120, 50);
		contentPane.add(btnProfessor);
		
		JButton btnDepartamento = new JButton("Departamento");
		btnDepartamento.setBounds(170, 150, 120, 50);
		...
		btnAlocado.setBounds(300, 150, 120, 50);
